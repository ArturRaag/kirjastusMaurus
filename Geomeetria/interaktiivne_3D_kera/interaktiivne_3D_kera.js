...
function setup() {
  ...
  stroke(100,180,200,35);
  strokeWeight(2);
  fill(100,180,200,5);
  
  raadius=Math.floor(Math.random()*100);
...
function draw() {
  ...
  text('R = ' +str(raadius), raadius_joonisel/3, -120);
  pop();
  ...
  beginShape();
    vertex(0,0,0);
    vertex(raadius_joonisel,0,0);
  endShape();
  pop();
  
  sphere(raadius_joonisel);
