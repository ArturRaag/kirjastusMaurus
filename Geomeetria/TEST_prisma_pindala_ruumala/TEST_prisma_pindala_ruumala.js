...
function Ylesanne(){
  ...
  if (mudeli_valik=="1"){ // PÕHI - KOLMNURK
     ...
     prisma_korgus = round_0(Math.random()*100);
     ...
     yhe_pohja_pindala = kolmnurga_korgus*pohja_kylg/2;
     kogu_pohja_pindala = 2* yhe_pohja_pindala;
     kylje_pindala = pohja_ymbermoot*prisma_korgus;
     tais_pindala = round_2(kogu_pohja_pindala+kylje_pindala);
     ruumala = round_2(yhe_pohja_pindala * prisma_korgus);

  console.log("St: "+str(tais_pindala)+", V: "+str(ruumala));
     suurused=["S","V"];
     suuruse_valik=random(suurused);
     if (suuruse_valik=="S"){
      yl_text.html("Prisma põhjaserv on a = " +str(pohja_kylg)+" ning prisma kõrgus H = "+str(prisma_korgus)+". Leia prisma täispindala St.");
      vastus=tais_pindala;
      katex.render("S = ",sisend_vastus.elt);
      radius_node.html("a = "+str(pohja_kylg));
      korgus_node.html("H = "+str(prisma_korgus));
      diagonal_1_node.html("");
      diagonal_2_node.html("");
     } else if (suuruse_valik=="V"){
      yl_text.html("Prisma põhjaserv on a = " +str(pohja_kylg)+" ning prisma kõrgus H = "+str(prisma_korgus)+". Leia prisma ruumala V.");
      vastus=ruumala;
  ...
  }  else if (mudeli_valik=="2"){ // PÕHI - NELINURK (korrapärane)
     nurkade_arv=5;
     pohja_kylg = round_0(Math.random()*100);
     prisma_korgus = round_0(Math.random()*100);
     
    
     pohja_ymbermoot = (nurkade_arv-1)*pohja_kylg;
     yhe_pohja_pindala = pohja_kylg*pohja_kylg;
     kogu_pohja_pindala = 2*yhe_pohja_pindala;
     kylje_pindala=pohja_ymbermoot*prisma_korgus;
     tais_pindala = round_2(kogu_pohja_pindala+kylje_pindala);
     ruumala = round_2(yhe_pohja_pindala * prisma_korgus);
  ...
  console.log("St: "+str(tais_pindala)+", V: "+str(ruumala));
     ...
     suuruse_valik=random(suurused);
     if (suuruse_valik=="S"){
      yl_text.html("Prisma põhiserv on a = " +str(pohja_kylg)+" ning prisma kõrgus H = "+str(prisma_korgus)+". Leia prisma täispindala St.");
      vastus=tais_pindala;
      katex.render("S = ",sisend_vastus.elt);
      radius_node.html("a = "+str(pohja_kylg));
      korgus_node.html("H = "+str(prisma_korgus));
      ...
      yl_text.html("Prisma põhiserv on a = " +str(pohja_kylg)+" ning prisma kõrgus H = "+str(prisma_korgus)+". Leia prisma ruumala V.");
      vastus=ruumala;
      katex.render("V = ",sisend_vastus.elt);
      radius_node.html("a = "+str(pohja_kylg));
      korgus_node.html("H = "+str(prisma_korgus));
  ...
  } else if (mudeli_valik=="3"){ // PÕHI - VIISNURK, KUUSNURK, SEITSENURK, KAHEKSANURK
     ...
     kolmnurga_korgus = round_2(Math.sqrt( pohja_kylg*pohja_kylg-(pohja_kylg/2)*(pohja_kylg/2) ));
     yhe_kolmnurga_pindala = kolmnurga_korgus * pohja_kylg / 2;
     N_nurga_pindala = (nurkade_arv-1) * yhe_kolmnurga_pindala;
        
     pohja_ymbermoot = (nurkade_arv-1)*pohja_kylg;
     yhe_pohja_pindala =  N_nurga_pindala;
     kogu_pohja_pindala = 2*yhe_pohja_pindala;
     kylje_pindala = pohja_ymbermoot*prisma_korgus;
     tais_pindala = round_2(kogu_pohja_pindala+kylje_pindala);
     ruumala = round_2(yhe_pohja_pindala * prisma_korgus);
     ...
     suuruse_valik=random(suurused);
     if (suuruse_valik=="S"){
      yl_text.html("On antud "+str(nurkade_arv-1)+"-nurkne prisma. Prisma põhiserv on a = " +str(pohja_kylg)+" ning prisma kõrgus H = "+str(prisma_korgus)+". Leia prisma täispindala St.");
      vastus=tais_pindala;
      katex.render("S = ",sisend_vastus.elt);
      radius_node.html("a = "+str(pohja_kylg));
      korgus_node.html("H = "+str(prisma_korgus));
      ...
      yl_text.html("On antud "+str(nurkade_arv-1)+"-nurkne prisma. Prisma põhiserv on a = " +str(pohja_kylg)+" ning prisma kõrgus H = "+str(prisma_korgus)+". Leia prisma ruumala V.");
      vastus=ruumala;
      katex.render("V = ",sisend_vastus.elt);
      radius_node.html("a = "+str(pohja_kylg));
      korgus_node.html("H = "+str(prisma_korgus));
