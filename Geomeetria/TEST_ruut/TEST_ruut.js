...
function Ylesanne(){
  ...
  if (mudeli_valik=="1"){
    yl_text.html("Leia ruudu pindala S, kui ruudu külg on a="+str(alus)+".");
    vastus=pindala;
    otsitav="S";
    kylg_A_node.html("a = "+str(alus));
  } else if (mudeli_valik=="2"){
    yl_text.html("Leia ruudu ümbermõõt P, kui ruudu külg on a="+str(alus)+".");
    vastus=perimeeter;
    otsitav="P";
    kylg_A_node.html("a = "+str(alus));
  } else if (mudeli_valik=="3"){
      yl_text.html("Leia ruudu külg a, kui ruudu pindala S on S="+str(pindala)+".");
      vastus=alus;
      otsitav="a";
      kylg_A_node.html("a = ?");
  } else if (mudeli_valik=="4"){
      yl_text.html("Leia ruudu külg a, kui ruudu ümbermõõt P on P="+str(perimeeter)+".");
      vastus=alus;
      otsitav="a";
      kylg_A_node.html("a = ?");
  } else if (mudeli_valik=="5"){
      yl_text.html("Leia ruudu pindala S, kui ruudu ümbermõõt P on P="+str(perimeeter)+".");
      vastus=pindala;
      otsitav="S";
      kylg_A_node.html("a = ?");
  } else if (mudeli_valik=="6"){
      yl_text.html("Leia ruudu ümbermõõt P, kui ruudu pindala S on S="+str(pindala)+".");
      vastus=perimeeter;
      otsitav="P";
      kylg_A_node.html("a = ?");
  }
...
function write_texts(){
  ...
  kylg_A_node=createP("a");
  kylg_A_node.position(width/asukoha_nr+155,height/asukoha_nr+65);
  kylg_A_node.style("font-family: 'Roboto',sans-serif;line-height: 140%; font-size: 1.00rem ");
